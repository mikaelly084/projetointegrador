...
<body>
  ...
  <a class="section" href="dv.html"><span><i class="fas fa-check-circle"></i> Validação de documentos</span><i class="fas fa-chevron-right"></i></a>
  ...
  <a class="section" id="logout-btn" href="#"><span><i class="fas fa-sign-out-alt"></i> Sair do aplicativo</span><i class="fas fa-chevron-right"></i></a>
  ...
  <nav class="nav">
    ...
    <a href="minhaconta.html" class="active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-3-3.87"/><path d="M4 21v-2a4 4 0 0 1 3-3.87"/><circle cx="12" cy="7" r="4"/></svg><span>Minha Conta</span></a>
  </nav>
